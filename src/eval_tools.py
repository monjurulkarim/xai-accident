...
def evaluation_train(all_pred, all_labels, time_of_accidents, fps=10.0):
    """
...
def evaluation(all_pred, all_labels, time_of_accidents, fps=10.0):
    """
    :param: all_pred (N x T), where N is number of videos, T is the number of frames for each video
    :param: all_labels (N,)
    :param: time_of_accidents (N,) int element
